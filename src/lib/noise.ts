/**
 * Perlin noise — shared by all ASCII renderers.
 * Uses a proper shuffled permutation table (not the LCG approximation).
 */

// Permutation table: a real shuffle of 0..255, doubled to 512 to avoid wrapping.
// Source: Ken Perlin's original reference implementation.
const P = [
...
/** 2-octave fbm — cheaper, used by ascii-name. */
